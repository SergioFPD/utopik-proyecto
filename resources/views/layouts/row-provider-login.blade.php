    ...
    <div class="provider-login-image">
        ...
        <div class="provider-login-container">
            <div class="left">
                ...
                <p class="text-shadow"><img src="{{ asset('storage/images/check-mark.svg') }}" alt="">Recibe
                    reservas de nuestros clientes</p>
                <p class="text-shadow"><img src="{{ asset('storage/images/check-mark.svg') }}" alt="">Multiplica
                    el éxito de tu negocio</p>
                <p class="text-shadow"><img src="{{ asset('storage/images/check-mark.svg') }}" alt="">Publica
                    experiencias VIP exclusivas</p>
